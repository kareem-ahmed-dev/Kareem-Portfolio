...
const en = {
  ...
  about: {
    ...
    title: "About Me",
    body: [
      "I'm Kareem Ahmed, a Front-End Developer passionate about building modern, responsive, and user-friendly websites and web applications.",
...
const ar: Dictionary = {
  ...
  about: {
    ...
    title: "نبذة عني",
    body: [
      "أنا كريم أحمد، مطور Front-End شغوف ببناء مواقع وتطبيقات ويب حديثة ومتجاوبة وسهلة الاستخدام.",
